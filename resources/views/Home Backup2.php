    ...
    <nav class="navbar navbar-expand text-center navbar-dark">
        ...
        <div class="w-100 text-center">
            <span id="searchFieldLogo" class="btn p-0 rounded-circle">
                <i class="fas fa-search fa-3x text-primary" onclick='window.location.href="/search";'>
                </i>
            </span>
        </div>
    </nav>
    ...
    <div id="NewsFeed">
        <div id="Center-Newsfeed">
            <div id="CreatePost" class="bg-white d-flex justify-content-center p-3">
                <img class="rounded-circle Message-Person-DP" id="createpostimage" src=" {{ $image }} ">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header d-flex justify-content-between">
                            ...
                            <span>
                                <a href="#" onclick='clearCreatePostModal()' ; class="close bg-secondary rounded-circle mt-0 mr-0 p-1" data-dismiss="modal">
                        ...
                        <div class="modal-body" id="CreatePostDialogueBox">
                            <img class="rounded-circle Message-Person-DP" id="modalimage" src=" {{ $image }} ">
                            <span id="modalname">{{$Name}}</span>
    ...
    <div id="Chat-Box" class="shadow-lg bg-white">
        <div id="ChatBoxTop" class="py-2 pl-2 shadow-lg d-flex justify-content-between">
            <span>
                ...
                <a href="/Profile/dummyuser" id="ProfileLink">
...
<script>
    ...
    function ChatTrigger(abc) {
        ...
        $("#ProfileLink").attr("href", `/Profile/${otheruser}`);
                ...
                $.each(data, function(index, value) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            let ProfileImg = data[0].ProfileIMG;
                            let ProfileName = data[0].Name;
                            //Have to Set the Default Number Of Likes
                            post(ProfileImg, ProfileName, postDate, posttext, postimage);
                        },
                        error: function(abc) {
                            alert(abc.responseText);
                        }
    ...
    CreateAdd("Images/Add2.jpg", "Laptop", "Lorem ipsum voluptas neque eius");
    ...
    function callPost() {
        if ($("#CreatePostForm").valid()) {
            ...
            post(PostUserImg, NameOfUser, PostDate, PostContent, PostImg);
    ...
    function post(PostUserImg, PostName, PostDate, PostContent, PostImg) {
        $("#CreatePost").after(`
